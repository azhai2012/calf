...
<h1><?php echo $name; ?><span><?php echo __('功能主治:').$uses; ?></span></h1>
</div> <!-- end h1_title -->

<div class="property"> <!-- begin property -->
    <div class="wrap"> <!-- begin wrap -->
       <ul class="meta">
		  <li id="StrPrice" class="detail-price"><span><?php echo __('价格:');?></span><strong id="J_StrPrice">￥<?php echo $price; ?></strong>元</li>
          <li id="Strpname" class="detail-pname"><span><?php echo __('通用名称：').$pname; ?></li>
          <li id="Strsec" class="detail-spec"><span><?php echo __('规格：').$spec; ?></li>
          <li id="Strunit" class="detail-unit"><span><?php echo __('单位：').$unit; ?></li>
          <li id="Strgroup" class="detail-group"><span><?php echo __('包装：').$group; ?></li>
          <li id="Strls" class="detail-ls"><span><?php echo __('批准文号：').$lsno; ?></span></li>
       </ul>
       <div class="key">
         <div class="skin naked">
    		<dl class="amount clearfix">
    		  ...
    		  <dd class="btn"><a href="#" class="b_s"><input type="button" id="submit"  value="<?php echo __('放入购物车');?>" /></a>
...
<div class="gallery">  <!-- begin gallery -->
  <!--itemPics-->
    <div class="pics clearfix" style="position:relative;"> 
      <a href="<?php echo $big_image; ?>"  rel="gal1" id="jprocimg"  title="" > 
      <img src="<?php echo $big_image; ?>" title="triumph"  style="border: 1px solid #666;width:300px; height:270px;"> 
     </a>  
    </div> 
    <br/><br>
...
<div class="bottom clearfix"><!-- begin bottom --> 
   <div class="b_detail"> <!-- begin b_detail -->
       <?php echo $get_product_discount_context; ?>
 ...
 <?php echo $get_procduct_posts_context; ?>
