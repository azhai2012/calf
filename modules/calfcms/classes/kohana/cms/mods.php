...
class Kohana_Cms_Mods extends Kohana_Cms {
	...
	private $_calfDb;
		...
		return new Kohana_Cms_Mods($id,$data);
	}
	
	public static function instance($classname,array $data = NULL){
		$class = 'Kohana_Cms_Mods_'.$classname;
	...
	function __construct($id,array $data=NULL){
		$this->_id = $id;
		$this->_data= $data;
		$this->_calfDb = Calfdb_Cms::instance('Body',$this->_id,$this->_data);
