...
class Kohana_Admin_Tuan {
	...
	/**
        ...
        */
		...
		$array_data = array(
			 array('id'=>1,'mod_name'=>'notices','name' =>'团购管理','url'=>'/admin/tuan/1',
			      ) , 
			 array('id'=>2,'mod_name'=>'news','name' =>'团购列表','url'=>'/admin/tuan/2',
			      ) , 
			 array('id'=>3,'mod_name'=>'advertising','name' =>'团购分析','url'=>'/admin/tuan/3',
			                  'lists'=>array(
