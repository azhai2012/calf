 ...
 *
 */
class Kohana_Calfdb_Admin_Body extends Kohana_Calfdb_Admin {

       /**
       * 
       */
       public function get_admin_body_array_data() {
           // TODO :
          $array_data = array(
			 array('id'=>1,'mod_name'=>'cms','name' =>'CMS管理','url'=>'/admin/index/1',
			              'lists'=>array(
			                   array('id'=>'11','mod_name'=>'product','name'=>'商品管理','url'=>'/admin/product'),
				      	   array('id'=>'12','mod_name'=>'modmanager','name'=>'模块管理','url'=>'/admin/modmanager'),
       ...
       * 
       */
       public function get_admin_body_adv_add_list_array_data() {
           // TODO :
             $array_data= array(
       ...
       * 
       */
       public function get_admin_body_notice_list_array_data() {
           // TODO :
        $array_data = array(
       ...
       * 
       */
       public function get_admin_body_news_add_list_array_data() {
           // TODO :
        $array_data = array(
       ...
       * 
       */
       public function get_admin_body_adv_list_array_data() {
           // TODO :
        $array_data = array(
