var Customers = {
	...
	getGrid:function(){
	  		$('#flexgrid').flexigrid({
					url: '/post/customer/list',
					dataType: 'json',
					colModel : [
						{display: '编号', name : 'id', width : 40, sortable : true, align: 'center'},
						{display: '客户名称', name : 'display_name', width : 180, sortable : true, align: 'left'},
					...
					searchitems : [
						{display: '编号', name : 'id'},
						{display: '客户名称', name : 'display_name', isdefault: true},
					...
					height: 375,  
				  	buttons:[
				     {name:'编辑选择',bimage:'/media/images/modify.gif',onpress:function(){Customers.Modify()}},
					 {name:'删除',bimage:'/media/images/delete.gif',onpress:function(){Customers.RowDelete()}},
					 {name:'导出',bimage:'/media/images/export.gif',onpress:function(){},
				      ...
				      {name:'导入',bimage:'/media/images/import.gif',onpress:function(){Customers.Imports()}},
	    ...
	    Imports:function(){
		   Customers.Showdialogs('/dialog/customer/export',600);
   	    },
	    ...
	    RowAdd:function(){
	        Customers.ShowOperating(1);
	    },
	    Modify:function(){
		       Customers.ShowOperating(0);
	    },
		Serialize:function(obj){
		    switch (obj.constructor){
			   case Object:
				 var str='{';
				 for (var o in obj){
					str += '"'+o+'"' +":"+Customers.Serialize(obj[o])+",";
				 }
	    ...
	    AddContent:function(){
            ...
            ary['imgs']=sr;	
	     	...
	     	serialize = Customers.Serialize(ary);
		    Customers.AddToDb(serialize); 
		   } 
		},
		ModityContent:function(){
            ...
            serialize = Customers.Serialize(ary);
		    Customers.UpdateToDb(serialize);4
		   }  
		},
		DeleteContent:function(obj){
		   ...
		   var serialize = '{}';
		   serialize = Customers.Serialize(ary);	 			
		   Customers.DeleteToDb(serialize);	
		...
		RowDelete:function(){
			 	     ...
			 	     if (a != null)
				     {
					     if (confirm('删除这些记录!确定吗？'))
						 {
				             var id = a.attr('id').substring(3);
			 	             Customers.DeleteContent(id);
			                 $('#flexgrid').flexReload(); 
			             }
			          }
			              else 
